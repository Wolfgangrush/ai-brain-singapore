---
name: retrospective
description: End-of-session save discipline for Singapore AI Brain users. Runs 2-pass leak-check (Rule 6: no internal-shorthand, no internal-paths, no personal-build references). Saves session learning so the firm gets smarter with every use.
allowed-tools: Bash, Read, Glob
---

# /retrospective — End-of-Session Save Discipline (Singapore)

Saves what the Singapore AI Brain learned this session. Runs at session end. The firm accumulates knowledge across sessions without leaking personal context.
...
- What legal domains were touched (corporate, dispute resolution, PDPA, SICC cross-border, arbitration, criminal, family, conveyancing, Islamic finance)
- What courts or jurisdictions were referenced (Supreme Court of Singapore — Court of Appeal + High Court, State Courts, SICC, SIAC)
- Any errors or blockers encountered

### Step 2: Run 2-pass leak-check (above)

### Step 3: If passes leak-check, write session summary
Save to `.ailawfirm-singapore/sessions/` with timestamp. Format:
```markdown
...
```
🧠 Singapore AI Brain — session saved.
...
## Output Format
```markdown
## /retrospective — Singapore AI Brain · Session Save
