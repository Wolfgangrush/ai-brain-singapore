# Contributing to AI Brain — Singapore

Thanks for wanting to help. **AI Brain — Singapore** is open source (MIT). Contributions of all sizes are welcome — typo fixes, statute-corpus corrections, new drafting templates, agent improvements, and translations.
...
```
ailawfirm_singapore/   ← core package (see ailawfirm_singapore/README.md for the module/agent guide)
tests/         ← test suite
