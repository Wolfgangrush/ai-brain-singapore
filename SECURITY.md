# SECURITY — AI Brain · Singapore

## Reporting a vulnerability

If you discover a security vulnerability in AI Brain — Singapore, please report it via **GitHub Security Advisories** at the repository:

https://github.com/Wolfgangrush/ai-law-firm-singapore/security/advisories/new
...
Out of scope:
- Vulnerabilities in upstream dependencies — report to those projects directly (we will track and patch)
- Vulnerabilities in cloud AI vendors (DeepSeek · Anthropic · Google · etc.) — report to those vendors directly
...
- We do NOT offer bug bounties at this time (we are an open-source project with no revenue)
