"""aibrain_singapore.brain.repl — terminal front door for the brain.

A small, dependency-free Read–Eval–Print Loop that talks to the brain's
:class:`aibrain_singapore.brain.router.think` function. The user types a
...
_BANNER = (
    "aibrain_singapore brain — terminal front door\n"
