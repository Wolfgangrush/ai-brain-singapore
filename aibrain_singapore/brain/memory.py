"""
aibrain_singapore.brain.memory
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Store:
    ~/.aibrain-singapore/memory/sessions.jsonl   (append-only, one JSON per line)
...
MEMORY_DIR: Path = Path(os.path.expanduser("~/.aibrain-singapore/memory/"))
