...
Usage:
    python3 -m aibrain_singapore.onboarding
    or: brain init
"""

from pathlib import Path
from aibrain_singapore.entity_registry import EntityRegistry
from aibrain_singapore.entity_detector import detect_entities, scan_for_detection
...
def _warn_ambiguous(people: list) -> list:
    ...
    """
    from aibrain_singapore.entity_registry import COMMON_ENGLISH_WORDS
...
""")
    ...
    print("\n  entity-aliasing entity registry: ~/.aibrain-singapore/alias_entities.md")
    print("  Critical facts bootstrap: ~/.aibrain-singapore/critical_facts.md")
