...
Priority: env vars > config file (~/.ailawfirm-singapore/config.json) > defaults
"""
    ...
    def __init__(self, config_dir=None):
        ...
        Args:
            config_dir: Override config directory (useful for testing).
                        Defaults to ~/.brain.
        """
        self._config_dir = Path(config_dir) if config_dir else Path(os.path.expanduser("~/.brain"))
