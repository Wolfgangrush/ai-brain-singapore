...
# Source of truth lives in stopwords.STOPWORDS (the union of this module's
# prior set and dialect's prior set) — bound here as `STOPWORDS` so the
# rest of this file can keep using the bare name without redefining it.
from .stopwords import STOPWORDS  # noqa: F401  (re-exported as STOPWORDS)
...
# (STOPWORDS is bound via the `from .stopwords import STOPWORDS` at the top of this file.)
PROSE_EXTENSIONS = {
    ".txt",
    ".md",
    ".rst",
