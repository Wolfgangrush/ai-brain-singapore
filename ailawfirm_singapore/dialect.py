...
# prior set and entity_detector's prior set) — import and re-bind to keep
# the legacy name working for callers that still reference _STOP_WORDS.
from .stopwords import STOPWORDS as _STOP_WORDS  # noqa: E402 — re-export
