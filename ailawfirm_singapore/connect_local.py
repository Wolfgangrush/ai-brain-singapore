...
Usage from CLI:
    ...
    ailawfirm-singapore connect-local --yes      # skip prompts
    ailawfirm-singapore connect-local --model qwen3:7b   # force a specific model

Result: ~/.ailawfirm-singapore/config.json is written with ai_provider=ollama and the
...
def install_ollama_instructions() -> None:
    ...
    print()
    print("Then run `ailawfirm-singapore connect-local` again.")
...
def cmd_connect_local(args) -> int:
    ...
    print("  ailawfirm-singapore connect-cloud --provider deepseek --cloud-warning-acknowledged")
    print()
    return 0
