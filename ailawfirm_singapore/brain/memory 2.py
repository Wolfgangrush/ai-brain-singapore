"""
ailawfirm_singapore.brain.memory
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Store:
    ~/.ailawfirm-singapore/memory/sessions.jsonl   (append-only, one JSON per line)
...
MEMORY_DIR: Path = Path(os.path.expanduser("~/.ailawfirm-singapore/memory/"))
