...
from ailawfirm_singapore.brain import memory
...
def run_reception() -> int:
    ...
    print("  Good day, Advocate & Solicitor. Booting your brain...")
    print("======================================================")
    print()
    print("  SYSTEMS CHECK")
    print("  -------------")
    ...
    for name in AGENTS:
        try:
            mod = importlib.import_module(f"ailawfirm_singapore.agents.{name}")
    ...
    router_ok = False
    try:
        router = importlib.import_module("ailawfirm_singapore.brain.router")
    ...
    # 7. Closing line
    print()
    print("  How may I help you today, Advocate & Solicitor?")
    print()
