...
Usage:
    python3 -m ailawfirm_singapore.onboarding
    or: brain init
"""

from pathlib import Path
from ailawfirm_singapore.entity_registry import EntityRegistry
from ailawfirm_singapore.entity_detector import detect_entities, scan_for_detection
...
def _warn_ambiguous(people: list) -> list:
    ...
    """
    from ailawfirm_singapore.entity_registry import COMMON_ENGLISH_WORDS
...
""")
    ...
    print("\n  entity-aliasing entity registry: ~/.ailawfirm-singapore/alias_entities.md")
    print("  Critical facts bootstrap: ~/.ailawfirm-singapore/critical_facts.md")
