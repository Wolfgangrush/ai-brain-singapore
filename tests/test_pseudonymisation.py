"""Tests for Pseudonymisation Gateway (Singapore · v0.2)."""
...
def test_aadhaar_redacted():
    ...
    clean, _ = gw.sanitize("Aadhaar 2345 2345 2340 belongs to the client.")
    assert "2345 2345 2340" not in clean
...
def test_desanitize_roundtrip():
    gw = PseudonymisationGateway()
    original = "Mr. John Smith filed Aadhaar 2345 2345 2340 with ₹4,50,000."
    ...
    assert "2345 2345 2340" in restored
...
def test_is_safe_for_cloud_detects_pii():
    gw = PseudonymisationGateway()
    safe, detected = gw.is_safe_for_cloud("Mr. John Smith with Aadhaar 2345 2345 2340")
